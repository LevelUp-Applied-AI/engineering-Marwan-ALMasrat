...
Follow these steps to set up the environment, run the code, and confirm it works:
...
3. **Confirm success**  
   - Successful execution is indicated by expected output in the terminal, for example:  
     ```
